        ...
        <div className="container">
          <div className="row">
            <div className="banner-text">
              ...
              <p>3+ Years of Experience. Proficiency area's are Javascript,Typescript,Redux,rxjs,Python,Database Design,Firebase,RestApi(DRF),Google Map api.</p>
            </div>
            <div className="banner-text">
      ...
      <section id="gallery">
        ...
        <div className="container">
          ...
          >
            ...
            <a href="https://play.google.com/store/apps/details?id=com.fislam.quran&hl=en&gl=US" target="_blank">Play store Link</a>
          </div>
          <div className="clr"></div>
        </div>
        <div className="container">
          ...
          <div className="gallery-item-des">
            ...
            <textarea value={bcs} />
            <a href="https://play.google.com/store/apps/details?id=com.fislam.bcsfor2day&hl=en&gl=US" target="_blank">Play store Link</a>
          </div>
          <div className="gallery-item">
        ...
        <div className="container">
          ...
          >
            ...
            <a href="https://play.google.com/store/apps/details?id=com.fislam.donate&hl=en&gl=US" target="_blank">Play store Link</a>
          </div>
          <div className="clr"></div>
        </div>
        ...
        <div className="container">
          <div className="head">
            <a>
              {" "}
              <img src={icons.android} alt="android" /> NaatLyric's including all Countries
            </a>
          </div>
          <div className="gallery-item-des">
            <h3>NaatLyric's including all Countries</h3>
            <textarea value={naat} />
            <a href="https://play.google.com/store/apps/details?id=com.fislam.naat&hl=en&gl=US" target="_blank">Play store Link</a>
          </div>
          <div className="gallery-item">
        ...
        <div className="container">
          ...
          >
            ...
            <a href="https://play.google.com/store/apps/details?id=com.fislam.dorud&hl=en&gl=US" target="_blank">Play store Link</a>
          </div>
          <div className="clr"></div>
        </div>
        ...
        <div className="container">
          ...
          <div className="gallery-item-des" style={{backgroundColor:'#ffd8ab'}}>
            <h3>NOTEpad copy and paste</h3>
            <textarea value={pad} style={{backgroundColor:'#ffd8ab'}}/>
            <a href="https://play.google.com/store/apps/details?id=com.fislam.note&hl=en&gl=US" target="_blank">Play store Link</a>
          </div>
          <div className="gallery-item">
